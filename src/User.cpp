...
User::User():name("unknown"),age(0),id(++counter),password("unknown"),email("unknown")
{
...
User::User(string n, int a, string p, string e):name(n),age(a),id(++counter),password(p),email(e)
{
