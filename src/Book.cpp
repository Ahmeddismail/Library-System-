#include "Book.h"
 ...
 Book::Book():title("unknown"),isbn("unknown"),id(++counter),category("unknown"),averageRating(0.0),num(0),sum(0)
 {
 ...
 Book::Book(string t, string i, string c, double a):title(t),isbn(i),id(++counter),category(c),averageRating(a),num(0),sum(0)
 {
